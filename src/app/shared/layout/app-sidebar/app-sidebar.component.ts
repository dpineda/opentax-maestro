...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        { name: "Wages & Income", path: "/wages-income" },
        { name: "Deductions & Credit", path: "/deductions-credit" },
        { name: "Other Tax Situations", path: "/other-tax-situations" },
        { name: "Federal Review", path: "/federal" },
      ]
    },
    /*
    {
